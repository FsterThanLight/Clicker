...
class Ui_Setting(object):
    def setupUi(self, Setting):
        ...
        self.gridLayout_2.addWidget(self.label_8, 3, 3, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.label_10, 5, 3, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.horizontalSlider_4, 5, 1, 1, 2)
        ...
        self.horizontalSlider_3.valueChanged['int'].connect(self.label_8.setNum)
        self.horizontalSlider_4.valueChanged['int'].connect(self.label_10.setNum)
    ...
    def retranslateUi(self, Setting):
        ...
        self.label_2.setText(_translate("Setting", "该模式进一步提高操作速度，取消所有操作时间间隔，但可能导致不稳定"))
        self.label_3.setText(_translate("Setting", "图像匹配精度："))
        self.label_5.setText(_translate("Setting", "时间间隔："))
        self.label_8.setText(_translate("Setting", "持续（毫秒）"))
        self.label_10.setText(_translate("Setting", "暂停（毫秒）"))
        ...
        self.label_6.setText(_translate("Setting", "间隔（毫秒）"))
